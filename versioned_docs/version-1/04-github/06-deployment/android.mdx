...
- Follow the setup steps from [this link](https://docs.fastlane.tools/actions/supply/) to create a
  service account

> -- **Note:** Keep your keystore and service_account.json file somewhere safe , you will need it
> later to upload new releases
...
- **ANDROID_KEYSTORE_BASE64** : Base64 of your keystore in step 1 (You can use an online base64
  encoder for this)

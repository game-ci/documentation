/**
 * Based on Docusaurus script
 *
 * @see https://github.com/facebook/docusaurus/blob/485cd5d12f767e01bb0f8c76017147de62308d88/admin/scripts/formatLighthouseReport.js
 */
...
const createMarkdownTableRow = ({ url, summary, reportUrl }) =>
  [
    ...
    .../** @type {(keyof LighthouseSummary)[]} */ (Object.keys(summaryKeys)).map((k) =>
      scoreEntry(summary[k]),
    ),
    `[Report](${reportUrl}) |`,
  ].join(' | ');

...
| `game-ci remote build` | Schedule an engine job through a provider plugin.                  |
...
| Remote jobs via provider plugins                | `game-ci remote build` with `@game-ci/orchestrator-plugin` |

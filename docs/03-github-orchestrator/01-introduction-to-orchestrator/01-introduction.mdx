...
For GitHub Actions, use [`game-ci/orchestrator`](https://github.com/game-ci/orchestrator). The action
wraps Unity Builder and exposes the provider and service inputs documented in this section. The
standalone CLI is not required for normal GitHub Actions usage.

...
| **Configuration Override** | Pull parameters dynamically from secret managers or files. See [Configuration Override](advanced-topics/configuration-override). |
...
| Parameter                   | Default | Description                                                                                                                                                                                                                                 |
| --------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `readInputOverrideCommand`  | —       | Command to read a parameter value from an external source. Use `{0}` as the parameter name placeholder. Built-in presets: `gcp-secret-manager`, `aws-secret-manager`. See [Configuration Override](advanced-topics/configuration-override). |
...
| ------------------ | ---------------------------------------------------- |
| `populateOverride` | Enable reading parameters from the override command. |

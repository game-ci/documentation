...
on the [GitHub Releases](https://github.com/game-ci/unity-builder/releases) page. Download the
binary for your OS and architecture, make it executable, and place it on your `PATH`.

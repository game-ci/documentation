...
| ------------------------------------------ | --------------------------------------------------- |
| General local or CI builds                 | [GameCI CLI](/docs/cli)                             |
| Remote builds through a friendly CLI       | `game-ci remote build` with the Orchestrator plugin |
...
an optional build plugin. You do not need to install the standalone Orchestrator CLI in that path.

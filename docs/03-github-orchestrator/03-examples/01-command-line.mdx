...
(excluding the base "game-ci" stack), and removes old CloudWatch log groups. Resources are deleted
immediately without confirmation.

:::caution This command has no dry-run mode and no interactive confirmation — it deletes matching
resources as soon as it runs. Make sure your AWS credentials are scoped to the correct account. :::

...
See [Custom Jobs](advanced-topics/build-services#custom-jobs) for the full reference.
...
- [Custom Jobs](advanced-topics/build-services#custom-jobs) - Full reference for custom job
  definitions

...
```mermaid
graph LR
    Runner["GitHub Actions Runner<br/>game-ci/orchestrator<br/>providerStrategy: azure-aci<br/>azureStorageType:<br/>azure-files / blob-copy /<br/>azure-files-nfs / in-memory"]
    API["Container Instances API"]
    Container["Container: unity-build<br/>Image: unityci<br/>Storage: ..."]

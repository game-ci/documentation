...
1. Install the Orchestrator CLI (see
   [Command Line](../introduction-to-orchestrator/examples/command-line))
...
See the [Command Line](../introduction-to-orchestrator/examples/command-line) page for more details
on CLI usage and the [Secrets](../secrets) page for managing credentials.

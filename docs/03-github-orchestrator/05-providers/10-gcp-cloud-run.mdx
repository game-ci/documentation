...
```mermaid
graph LR
    Runner["GitHub Actions Runner<br/>game-ci/orchestrator<br/>providerStrategy: gcp-cloud-run<br/>gcpStorageType:<br/>gcs-fuse / gcs-copy /<br/>nfs / in-memory"]
    API["Cloud Run Jobs API"]
    Job["Job: unity-build<br/>Image: unityci<br/>Storage: ..."]

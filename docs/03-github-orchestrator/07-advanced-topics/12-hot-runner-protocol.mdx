...
- Returns structured results via the [storage and output system](storage#structured-build-outputs)
...
- **[Storage and Outputs](storage#structured-build-outputs)** - Return structured, typed results.

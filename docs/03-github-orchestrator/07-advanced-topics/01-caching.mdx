...
[Self-Hosted Machines](self-hosted-machines#dag-file-repair) for implementation
details.
...
[Self-Hosted Machines](self-hosted-machines#lfs-pointer-poisoning) for detection
scripts.
...
See [Self-Hosted Machines](self-hosted-machines#profile-switching) for the fingerprinting pattern.

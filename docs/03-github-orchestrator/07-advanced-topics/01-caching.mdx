...
[Self-Hosted Runner Reliability](self-hosted-reliability#dag-file-repair) for implementation
details.
...
[Self-Hosted Runner Reliability](self-hosted-reliability#lfs-pointer-poisoning) for detection
scripts.
...
See [Self-Hosted Runner Reliability](self-hosted-reliability#profile-switching) for the

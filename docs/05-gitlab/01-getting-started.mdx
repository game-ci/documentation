...
Note: This setup assumes that your unity project is at the root of the repository. If your project
is in a subfolder, you will need to adjust the paths in the commands below. You will also need to
adjust `UNITY_DIR` in `.gitlab-ci.yml` to point to the correct directory.
...
(in addition to your existing project files):

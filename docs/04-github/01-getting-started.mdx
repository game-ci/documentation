import ReactPlayerWrapper from '@site/src/components/ReactPlayerWrapper/ReactPlayerWrapper';
...
<ReactPlayerWrapper url='https://www.youtube-nocookie.com/embed/M2BZr02uai0' />

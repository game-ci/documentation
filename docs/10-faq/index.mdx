...
GameCI's primary, maintained built-in package is for **[Unity](https://unity3d.com/)**. That is the
most mature path today, with official containers, GitHub Actions, licensing flows, build targets,
and documentation.

The broader GameCI CLI and Orchestrator architecture is game-engine agnostic. It includes built-in
engine configurations beyond Unity, and the plugin API can integrate additional game engines as
...
The **GameCI CLI** also makes it easier to integrate game builds with any CI/CD service. Unity is
the primary built-in package, with built-in configurations for other engines and a plugin API for
adding new engine providers. See our [Roadmap v3.0.0](https://github.com/orgs/game-ci/projects/4).
...
- [Gabriel "GabLeRoux" Le Breton](https://gableroux.com), founder of GameCI, President at
  [Tobafeu Studio](https://tobafeustudio.com), full time dev at [TLM](https://tlmgo.com/) and former
  lecturer at [UQAC](https://uqac.ca/).
- [Webber Webbink](https://takken.io/), founder of GameCI and Senior Software Engineer at

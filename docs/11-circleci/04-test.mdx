...
At the end of the run, the test results are parsed to JUnit
and [stored](https://circleci.com/docs/collect-test-data) in CircleCI so that [test insights](https://circleci.com/docs/insights-tests) can be used. You can access test insights from the CircleCI
web app.

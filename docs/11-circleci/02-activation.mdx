...
Now you are prepared to start testing and [building](/docs/circleci/build) your Unity project.
However, remember to reference your context in every job you run; otherwise, they will fail:

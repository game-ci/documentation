...
"advanced topics / [custom steps](advanced-topics/custom-hooks/container-hooks) +
[custom hooks](advanced-topics/custom-hooks/custom-hooks)")
...
Specify yaml based [hooks](advanced-topics/custom-hooks/custom-hooks) or pre/post build
[steps](advanced-topics/custom-hooks/container-hooks).

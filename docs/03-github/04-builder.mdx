...
You should also set all the Android Keystore options (see below). Refer to (this section of the Google Play Deployment Guide)[https://game.ci/docs/github/deployment/android#3-generate-an-upload-key-and-keystore] for keystore setup.

...
Configure the android sdk version. If used, must be in sample format "platforms;android-33". See [Android Sdk Manager docs](https://developer.android.com/tools/sdkmanager).

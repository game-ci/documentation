...
After performing [Basic setup](#basic-setup), two extra steps are required for testing Unity
packages.
...
See the [GitHub Issue](https://github.com/game-ci/unity-test-runner/issues/227) for more details.
    ...
    strategy:
      ...
      matrix:
        projectPath:
          - test-package
        unityVersion:
          - '2020.3.0f1' # must be included for package testing
        testMode:
          - playmode
          - editmode
    steps:
      ...
      - uses: game-ci/unity-test-runner@v2
        ...
        with:
          ...
          githubToken: ${{ secrets.GITHUB_TOKEN }}
          checkName: ${{ matrix.testMode }} Test Results
          coverageOptions: 'generateAdditionalMetrics;generateHtmlReport;generateBadgeReport;assemblyFilters:+my.assembly.*,-*Tests*'
      - uses: actions/upload-artifact@v2
        if: always()
        with:
          name: Test results for ${{ matrix.testMode }}

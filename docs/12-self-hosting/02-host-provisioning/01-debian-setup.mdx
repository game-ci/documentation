...
2. Add required the apt sources and upgrade your system to the latest version.
...
3. Apply system updates and upgrades
...
This will not work for data-center cards or hosts which require GRID drvers.
...
1. Set your system distribution name to debian11 as workaround until nvidia adds official debian12
   support

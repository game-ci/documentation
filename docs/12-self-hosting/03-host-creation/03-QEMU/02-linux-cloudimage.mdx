...
### 4. Create a Cloud-Init file

See the [Cloud-Init](https://cloudinit.readthedocs.io/en/latest/topics/examples.html) official docs
for more information about Cloud-Init. More advanced templates are available in the
...
### 5. Create a Cloud-Init disk

```bash
cloud-localds seed.img Cloud-Init.yaml
```

### 6. Choose a cloud-image to use as the base OS:
...
### 7. Download the image with `wget`
...
### 8. Create a virtual disk using the cloud-image as a read-only backing file.

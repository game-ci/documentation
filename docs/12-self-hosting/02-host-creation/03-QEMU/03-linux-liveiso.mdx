...
phyiscal machines and are suited for use in long-lived virtual-private servers.
...
7. Follow the instructions for Debain/Ubuntu installation using the guides in the
   [Bare-Metal](docs/12-self-hosting/02-host-creation/02-bare-metal.mdx) section.

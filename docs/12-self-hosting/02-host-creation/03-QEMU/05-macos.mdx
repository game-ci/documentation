...
[OSX-KVM](https://github.com/kholia/OSX-KVM) wich will help you create a **Virtual Hackintosh**.
...
### 4. Format and rename the empty storage volumes
...
### 6. Choose the `Reinstall MacOS` option from the main menu
...
### 7. Choose your formatted volumes as the install location
...
### 9. Boot into MacOS and complete the account creation process
...
### 10. Enable 'Remote Login' from the 'Sharing' menu in System Settings

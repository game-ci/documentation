...
The Github actions runner application is quite easy to install. The following is the most basic
method. For more in-depth guidance please refer to the official documentation:
...
1. Copy and paste the following int your terminal to create the script, or download it from (link
   here TODO)

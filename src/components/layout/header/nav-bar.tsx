import SearchBar from '@site/src/components/layout/header/search-bar';
import SourceLinks from '@site/src/components/layout/header/source-links';
import { useTopLevelRoute } from '@site/src/core/hooks/use-top-level-route';

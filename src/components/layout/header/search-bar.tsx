...
import Configuration from '@site/src/components/search/configuration';
import SearchResults from '@site/src/components/search/results';
import Stats from '@site/src/components/search/stats';
